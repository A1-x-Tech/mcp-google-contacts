...
**In the app:** open **Settings → Plugins → MCP servers**, select **Add server**, then add `npx -y mcp-google-contacts@latest` with `GOOGLE_CONTACTS_CLIENT_ID`, `GOOGLE_CONTACTS_CLIENT_SECRET` and `GOOGLE_CONTACTS_REFRESH_TOKEN`.
