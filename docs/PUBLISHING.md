...
(`io.github.A1-x-Tech/mcp-google-contacts`). Check before publishing — all three must
...
2. Point it at `https://github.com/A1-x-Tech/mcp-google-contacts`. LobeHub pulls the README,
   tool list and install config (`npx -y mcp-google-contacts`) automatically.
